<template>
  <div class="pager-wrapper" v-if="totalPage > 0">
    ...
    <div v-if="showJump" v-show="totalPage > 1" class="pager-jump">
      ...
      <input type="number" autocomplete="off" min="1" :max="totalPage" v-model="jumpPage" class="jump-input" onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))">
      <span>页</span>
      <a class="go" @click="go(jumpPage)">确定</a>
    </div>
  </div>
</template>
<script>
